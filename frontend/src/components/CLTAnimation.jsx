...
export default function CLTAnimation({
  ...
  useEffect(() => {
    ...
    const run = () => {
      ...
      // 4) CROSSFADE: Market/Structure fade out WHILE Logo fades in
      timeouts.current.push(
        setTimeout(() => {
          const market = $("market");
          const structure = $("structure");
          ...
          // Fade out market and structure slowly
          if (market) {
            market.animate(
              [
                { opacity: 1 },
          ...
          // At the same time, fade in logo from center
          if (logo) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ACTUAL CLT ACADEMY LOGO - Centered, no background, white/red colors */}
        <g id="logo" className="hidden" style={{ opacity: 0 }}>
          {/* Center the logo at viewBox center (600, 300) */}
          <g transform="translate(600, 300) scale(0.55) translate(-405, -355)">
            {/* C Letter - White (was black) */}
            ...
            {/* L Letter - White main part (was black) */}
