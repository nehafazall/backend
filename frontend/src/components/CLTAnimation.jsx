 ...
 * - Uses actual CLT Academy logo with crossfade effect
 */
export default function CLTAnimation({
  ...
  useEffect(() => {
    ...
    const resetVisibility = () => {
      ...
      if (market) {
        ...
        market.style.transform = "translate(0,0) scale(1)";
      }
      if (structure) {
    ...
    const run = () => {
      ...
      // 4) SIMULTANEOUS CROSSFADE: Market/Structure fade out WHILE Logo fades in
      timeouts.current.push(
        setTimeout(() => {
          const market = $("market");
          const structure = $("structure");
          ...
          // AT THE SAME TIME: Fade in logo slowly from center
          if (logo) {
  ...
  return (
    ...
    >
      ...
      >
        {/* No background rect - transparent to show container background */}
